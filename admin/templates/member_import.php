...
<form action="?action=member_import&todo=doimport" method="post" method="post" enctype="multipart/form-data">
<input type="hidden" value="<?php echo $formhash;?>" name="formhash">
<table align="center" class="formtable" cellpadding="0" cellspacing="1" width="97%">
	<tr>
          <td width="40%" align="right">标准xls例子</td>
          <td width="60%"><a href="./data/upload/member_import_demo.xls">点这里下载标准XLS</a></td>
    </tr>
	<tr>
