...
<table width="98%"  border="0" cellpadding="0" cellspacing="0" align="center">
  ...
  <div class="desktop">
  	<div class="desktop_itme wrap" id="wrap">
  	<ul id="menu"> 
<li><a href="javascript:alert('即将实现')">报名该赛事</a></li>
<li><a href="javascript:alert('即将实现')">颁奖</a></li>
<li><a href="javascript:alert('即将实现')">结束比赛</a></li>
</ul> 

  		<div class="desktop_name">这个是演示</div>
  		<div class="desktop_num">人数/上限:5/10</div>
  		<div class="desktop_time">开赛时间:2013-9-20 12:07:14</div>
  	</div>
